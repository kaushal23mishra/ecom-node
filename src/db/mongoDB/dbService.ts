...
const mongoDbService = (Model) => {
  ...
  const updateOne = (filter, data, options = { new: true }) =>
    new Promise((resolve, reject) => {
  ...
  const deleteOne = (filter, options = { new: true }) =>
    new Promise((resolve, reject) => {
