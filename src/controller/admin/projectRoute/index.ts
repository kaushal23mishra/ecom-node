...
const bulkInsertProjectRouteUsecase =
  require('../../../use-case/projectRoute/bulkInsertProjectRoute')({ projectRouteDb });
...
const bulkUpdateProjectRouteUsecase =
  require('../../../use-case/projectRoute/bulkUpdateProjectRoute')({ projectRouteDb });
const softDeleteManyProjectRouteUsecase =
  require('../../../use-case/projectRoute/softDeleteManyProjectRoute')({
    projectRouteDb,
    routeRoleDb,
  });
const deleteManyProjectRouteUsecase =
  require('../../../use-case/projectRoute/deleteManyProjectRoute')({
    projectRouteDb,
    routeRoleDb,
  });
const softDeleteProjectRouteUsecase =
  require('../../../use-case/projectRoute/softDeleteProjectRoute')({
    projectRouteDb,
    routeRoleDb,
  });
const partialUpdateProjectRouteUsecase =
  require('../../../use-case/projectRoute/partialUpdateProjectRoute')({ projectRouteDb });
...
const bulkInsertProjectRoute = projectRouteController.bulkInsertProjectRoute(
  bulkInsertProjectRouteUsecase
);
const findAllProjectRoute = projectRouteController.findAllProjectRoute(findAllProjectRouteUsecase);
const getProjectRouteCount = projectRouteController.getProjectRouteCount(
  getProjectRouteCountUsecase
);
const bulkUpdateProjectRoute = projectRouteController.bulkUpdateProjectRoute(
  bulkUpdateProjectRouteUsecase
);
const softDeleteManyProjectRoute = projectRouteController.softDeleteManyProjectRoute(
  softDeleteManyProjectRouteUsecase
);
const deleteManyProjectRoute = projectRouteController.deleteManyProjectRoute(
  deleteManyProjectRouteUsecase
);
const softDeleteProjectRoute = projectRouteController.softDeleteProjectRoute(
  softDeleteProjectRouteUsecase
);
const partialUpdateProjectRoute = projectRouteController.partialUpdateProjectRoute(
  partialUpdateProjectRouteUsecase
);
